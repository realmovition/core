...
DEFAULT_RECORD='/mnt/synology/raw-data/2026-04-13-06-54-28/20260413065428.record.00000'
...
RECORD_FILE=${RECORD_FILE:-$DEFAULT_RECORD}
...
python "$REPO_ROOT/scripts/release/generate_pycyber_api_docs.py" --record-file "$RECORD_FILE" --out "$OUT_FILE"
